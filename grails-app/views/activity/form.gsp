...
%{--            <div class="mb-4">--}%
                ...
                <div class="mb-4 dropdown">
                    ...
                    <g:select
                            name="activity"
                            id="activity"
                            class="form-select ${hasErrors(bean: activityCommand, field: "activity", "is-invalid")}"
                    ...
                    <g:hasErrors bean="${activityCommand}" field="activity">
                        <div  class="invalid-feedback">
                            <g:eachError bean="${activityCommand}" field="activity" var="error">
